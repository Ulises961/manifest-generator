...
class PromptBuilder:
    ...
    def generate_prompt(self, microservice: Dict[str, Any]) -> str:
        ...
        prompt += "\nFor reference, here are also the microservice's json drafts:\n"
    ...
    def generate_second_pass_prompt(self) -> None:
        ...
        self.prompt = (
            ...
            "Below are a set of synthetic json manifests generated by an LLM. Your task is to clean them and output a production ready manifest"
            "Use a json format to generate the output."
            "Requirements:\n"
