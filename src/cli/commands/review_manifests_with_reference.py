...
from cli.functions.review_manifests_with_reference_helper import run_review_manifests_with_reference
...
def review_manifests_with_reference(
    ...
    """Review the generated manifests using the LLM for best practices, security, and correctness. The review is done by comparing with human authored manifests."""
    ...
    run_review_manifests_with_reference()