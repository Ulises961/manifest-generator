...
class EmbeddingsClient:
    ...
    def get_similarity(self, text1: str, text2: str) -> Optional[Dict[str, Any]]:
        ...
        self.logger.info(f"Comparing '{text1}' with '{text2}'")
    ...
    def decide_secret(self, secret: str) -> Optional[Dict[str, Any]]:
        ...
        self.logger.info(f"Classifying secret: {secret}")
    ...
    def classify_label(self, label: str) -> Optional[Dict[str, Any]]:
        ...
        self.logger.info(f"Classifying label: {label}")
    ...
    def classify_service(
        ...
        self.logger.info(f"Classifying service: {service}")
